                 ...
                 <div class="col-md-8">
                     ...
                     <div class="kf_courses_detail_wrap">
                         <div class="courses_detail_heading">
                             <h4>Learn Spoken English and English Subtitles</h4>
                         </div>

                         <ul class="course_detail_meta">
                             <li><i class="fa fa-user"></i><a href="#">John Doe</a></li>
                             <li><i class="fa fa-clock-o"></i>Dcember 29, 2015</li>
                         ...
                         <div class="kf_courses_tabs">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation"><a href="#coursestructure" aria-controls="coursestructure" role="tab" data-toggle="tab">Course Structure</a></li>
                                <li role="presentation"><a href="#entryrequirment" aria-controls="entryrequirment" role="tab" data-toggle="tab">Entry Requirment</a></li>
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane active" id="coursedetails">
                                    ...
                                    <div class="study_table_wrap">
                                        ...
                                        <p>Suspendisse in orci enim.Etiam pharetra erat sed fermentum feugiat velit mauris egestas quam ut aliquam massa nisl quis neque fermentum feugiat velit.</p>
                                    </div>
                                    ...
                                    <div class="study_table_wrap">
                                        ...
                                        <p><b>Nam nec tellus a odio tincidunt :</b> auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra per inceptos himenaeos.This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean lorem quis bibendum auctor nisi elit consequat ipsum nec sagittis sem nibh id elit.</p>

                                        <p><b>Excepteur sint occaecat cupidatat non : </b>auctor a ornare odio. Sed non  mauris vitae erat consequat auctor eu in elit. Class aptent taciti sociosqu ad litora torquent per conubia nostra per inceptos himenaeos.This is Photoshop's version  of Lorem Ipsum.</p>

                                    </div>
                                    <!-- STUDY TABLE WRAP END -->

                                    <!-- STUDY TABLE WRAP START -->
                                    <div class="study_table_wrap border_none">
                                        <h6>Student’s Destinations</h6>
                                        <p>Sed ut imperdiet nisi. Proin condimentum fermentum nunc. Etiam pharetra erat sed fermentum velit mauris egestas quam ut aliquam massa nisl quis neque. Suspendisse in orci enim.Etiam pharetra erat sed fermentum feugiat velit mauris egestas quam ut aliquam massa nisl quis neque</p>
                        ...
                        <div class="blog_thumb_wrap">
                            ...
                            <div class="row">
                                <div class="col-md-4 col-sm-4 ">
                                    <figure>
                                        <img alt="" src="extra-images/blog_detail1.jpg">
                                        <figcaption><a href="#"><i class="fa fa-search"></i></a></figcaption>
                                    </figure>
                                </div>
                                <div class="col-md-4 col-sm-4">
                                    <figure>
                                        <img alt="" src="extra-images/blog_detail2.jpg">
                                        <figcaption><a href="#"><i class="fa fa-search"></i></a></figcaption>
                                    </figure>
                                </div>
                                <div class="col-md-4 col-sm-4">
                                    <figure>
                                        <img alt="" src="extra-images/blog_detail3.jpg">
                                        <figcaption><a href="#"><i class="fa fa-search"></i></a></figcaption>
                                    </figure>
                                </div>
                                <div class="col-md-4 col-sm-4 ">
                                    <figure>
                                        <img alt="" src="extra-images/blog_detail4.jpg">
                                        <figcaption><a href="#"><i class="fa fa-search"></i></a></figcaption>
                                    </figure>
                                </div>
                                <div class="col-md-4 col-sm-4">
                                    <figure>
                                        <img alt="" src="extra-images/blog_detail5.jpg">
                                        <figcaption><a href="#"><i class="fa fa-search"></i></a></figcaption>
                                    </figure>
                                </div>
                                <div class="col-md-4 col-sm-4">
                                    <figure>
                                        <img alt="" src="extra-images/blog_detail6.jpg">
                                        <figcaption><a href="#"><i class="fa fa-search"></i></a></figcaption>
                                    </figure>
                                </div>
                            </div>
                        ...
                        <div class="about_autor">
                            <figure><img src="extra-images/author.jpg" alt=""></figure>
                    ...
                    <div class="kf-sidebar">
                        ...
                        <div class="sidebar_register_wrap">
                            ...
                            <ul class="sidebar_register_des">
                                <li>Price : <span class="green">$6589</span></li>
                                <li>Lessons : 12</li>
                                <li>Length : 12 hours</li>
                                <li>Level : Basic</li>
                                <li>Price : $6589</li>
