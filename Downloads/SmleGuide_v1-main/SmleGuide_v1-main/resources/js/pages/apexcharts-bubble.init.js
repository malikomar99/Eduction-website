...
var options = {
  ...
  colors: ["#287F71", "#963b68", "#E7366B", "#108dff"],
  dataLabels: {
    enabled: false,
  },
  fill: {
...
var chart = new ApexCharts(
  document.querySelector("#simple_bubble_chart"),
  options
);
chart.render();
...
var options = {
  ...
  colors: ["#287F71", "#963b68", "#E77636", "#01D4FF"],
  yaxis: {
    max: 70,
  },
  theme: {
...
var chart = new ApexCharts(
  document.querySelector("#animation_bubble_chart"),
  options
);
chart.render();
