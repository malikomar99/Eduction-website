...
var chart = new ApexCharts(
  document.querySelector("#distributed_timeline_chart"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#multi_timeline_chart"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#advanced_timeline_chart"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#group_timeline_chart"),
  options
);
chart.render();
...
var chart = new ApexCharts(
  document.querySelector("#dumbbell_timeline_chart"),
  options
);
chart.render();
