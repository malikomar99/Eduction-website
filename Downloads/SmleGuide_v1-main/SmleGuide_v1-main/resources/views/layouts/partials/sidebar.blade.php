            ...
            <ul id="side-menu">
                ...
                <li>
                    <a href="#sidebarDashboards" data-bs-toggle="collapse">
                        <i data-feather="home"></i>
                        <span> Smle Guide </span>
                        <span class="menu-arrow"></span>
                    </a>
                    <div class="collapse" id="sidebarDashboards">
                        <ul class="nav-second-level">
                            <li>
                                <a href="{{ route('service') }}" class="tp-link">Services</a>
                            </li>

                            <li>
                                <a href="{{ route('dataflow') }}" class="tp-link">Data Flow</a>
                            </li>
                            {{-- <li>
                            ...
                            <li>
                                <a href="{{ route('courseFiles.index') }}" class="tp-link">Course Files</a>
                            </li>
                            <li>
                                <a href="{{ route('userSubscription.index') }}" class="tp-link">Subscriptions</a>
                            </li> --}}
                ...
                <li class="mb-2">
                    ...
                    <li class="mb-2">
                        ...
                        <div class="collapse" id="sidebarcourses">
                            <ul class="nav-second-level">
                                ...
                                <li>
                                    <a href="{{ route('course.videos.index')}}" class="tp-link">Course Videos</a>
                                </li>      
                                <li>
                                    <a href="{{ route('tests.index')}}" class="tp-link">Tests</a>
                                </li>
                                <li>
                                    <a href="{{ route('questions')}}" class="tp-link">Mock Tests</a>
                                </li>
                    ...
                    <li class="mb-2">
                        <a href="#sidebarSubscriptions" data-bs-toggle="collapse">
                        ...
                        <div class="collapse" id="sidebarSubscriptions">
                            <ul class="nav-second-level">
                                <li>
                                    <a href="{{ route('course.purchase.index')}}" class="tp-link">Course Purchases</a>
                                </li>
                    ...
                    <li class="mb-2">
                        ...
                        <div class="collapse" id="sidebarbanners">
                            <ul class="nav-second-level">
                                <li>
                                    <a href="{{ route('banners.index')}}" class="tp-link">Banners</a>
                                </li>
                    ...
                    <li class="mb-2">
                        <a href="{{ route('business_settings.edit')}}" class="tp-link">
                ...
                <ul id="side-menu">
                    ...
                    {{-- <li>
                        ...
                        <div class="collapse" id="sidebarDashboards2">
                            <ul class="nav-second-level">
                                <li>
                                    <a href="{{ route('any', 'index')}}" class="tp-link">CRM</a>
                                </li>
                                <li>
                                    <a href="{{route('second', ['dashboards', 'analytics'])}}" class="tp-link">Analytics</a>
                                </li>
                                <li>
                                    <a href="{{route('second', ['dashboards', 'ecommerce'])}}" class="tp-link">eCommerce</a>
                                </li>
                                <li>
                                    <a href="{{route('second', ['dashboards', 'projects'])}}" class="tp-link">Projects</a>
                                </li>
                                <li>
                                    <a href="{{route('second', ['dashboards', 'hrm'])}}" class="tp-link">HRM</a>
                                </li>
                                <li>
                                    <a href="{{route('second', ['dashboards', 'jobs'])}}" class="tp-link">Jobs</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li>
                        ...
                        <div class="collapse" id="sidebarAuth">
                            <ul class="nav-second-level">
                                ...
                                <li>
                                    <a href="{{ route('second', ['auth', 'lock-screen'])}}" class="tp-link">Lock Screen</a>
                                </li>
                                <li>
                                    <a href="{{ route('second', ['auth', 'confirm-mail'])}}" class="tp-link">Confirm Mail</a>
                                </li>
                                <li>
                                    <a href="{{ route('second', ['auth', 'email-verification'])}}" class="tp-link">Email Verification</a>
                                </li>
                                <li>
