                        ...
                        <div class="mb-0 p-0 p-lg-3">
                            <div class="mb-0 border-0 p-md-4 p-lg-0">
                                ...
                                <div class="auth-title-section mb-4 text-lg-start text-center">
                                    ...
                                    <p class="text-muted fs-14 mb-0">Sign up today to unlock exclusive content, enjoy
                                        special offers, and be the first to hear about exciting updates and announcements.
                                    </p>
                                </div>
                                ...
                                <div class="pt-0">
                                    <form method="POST" action="{{ route('login.submit') }}" class="my-4">
                                        @csrf
                                        ...
                                        <div class="form-group mb-0 row">
                                            <div class="col-12">
                                                <div class="d-grid">
                                                    <button class="btn btn-primary fw-semibold" type="submit"> Log In
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
