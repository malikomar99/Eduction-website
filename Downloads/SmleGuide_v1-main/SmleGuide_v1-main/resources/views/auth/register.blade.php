                            ...
                            <div class="mb-0 border-0 p-md-4 p-lg-0">
                                ...
                                <div class="pt-0">
                                    <form method="POST" action="{{ route('register.submit') }}">
                                        {{-- <form method="POST" action="{{ route('register.submit') }}"  class="my-4"> --}}
                                        @csrf
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" type="text" name="name" id="name" required placeholder="Enter your Full Name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input class="form-control" type="tel" name="mobile" id="mobile"
                                                required="true" placeholder="Enter your Mobile number with Country Code">
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="checkbox-signin">I agree to the <a href="#" class="text-primary fw-medium" required> Terms and Conditions</a></label>
                                            </div>
                                        </div><!--end col-->
                                    </div> --}}
