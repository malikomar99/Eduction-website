            ...
            <div class="card overflow-hidden">
                <div class="card-body">
                    <div class="widget-first">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <h3 class="mb-0 fs-26 text-dark me-2me-3">57, 800</h3>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="widget-first">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <h3 class="mb-0 fs-26 text-dark me-2 m-3">57,800</h3>
                            <span class="badge badge-custom-second text-success bg-success-subtle fw-medium rounded-4 fs-14 me-2">+ 12.5%</span> 
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="widget-first">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <h3 class="mb-0 fs-26 text-dark me-2me-3">$637,254</h3>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="widget-first">
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <h3 class="mb-0 fs-26 text-dark me-2me-3">142 Items</h3>
                            <span class="badge badge-custom-second text-success bg-success-subtle fw-medium rounded-4 fs-13 me-2">+ 12.5%</span> 
                        </div>
...
@vite(['resources/js/pages/ecommerce-dashboard.init.js', 'resources/js/pages/vector-maps.init.js'])
@endsection
