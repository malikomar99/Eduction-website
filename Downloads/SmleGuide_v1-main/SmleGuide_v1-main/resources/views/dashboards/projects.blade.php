            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 col-lg-6 col-6 align-items-center">
                            ...
                            <tr>
                                ...
                                <td class="">
                                    <div class="avatar-group avatar-list-stack">
                                        ...
                                        <a href="#">
                                            <img class="avatar-img avatar avatar-xs rounded-circle img-fluid"
                                                src="/images/users/user-2.jpg" alt="Ab Hadley">
                                        </a>
                                        <a href="#">
                                            <img class="avatar-img avatar avatar-xs rounded-circle img-fluid"
                                                src="/images/users/user-3.jpg" alt="Adolfo Hess">
                                        </a>
                                        <a href="#">
                                            <img class="avatar-img avatar avatar-xs rounded-circle img-fluid"
...
@section('scripts')
@vite(['resources/js/pages/projects-dashboard.init.js'])
@endsection
