                ...
                <div class="card-body">
                    <div class="row">
                        <div class="container-fluid p-0">
                            <form action="{{ route('dataflow.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4 col-12">
                                        ...
                                        <input type="text" name="passport_no" id="passport_no" class="form-control"
                                            placeholder="Passport Number" value="{{ old('passport_no') }}" required>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        ...
                                        <input type="email" name="dataflow_email" id="dataflow_email" class="form-control"
                                            placeholder="Enter Dataflow Email" value="{{ old('dataflow_email') }}"  required >
                                    </div>
                                    ...
                                    <div class="col-md-4 col-12">
                                        ...
                                        <input type="text" name="dataflow_password" id="dataflow_password"
                                            class="form-control" placeholder="Enter dataflow password" value="{{ old('dataflow_password') }}" >
                                    </div>
                                   ...
                                   <div class="col-md-4 col-12">
                                    ...
                                    <div class="col-md-4 col-12">
                                        ...
                                        <select class="form-select @error('status') is-invalid @enderror" name="status" id="status">
                                            ...
                                            <option value="dataflow_pending" {{ old('status') == 'dataflow_pending' ? 'selected' : '' }}>Dataflow Pending</option>
                                            <option value="application_submitted" {{ old('status') == 'application_submitted' ? 'selected' : '' }}>Application Submitted</option>
                                            <option value="application_in_progress" {{ old('status') == 'application_in_progress' ? 'selected' : '' }}>Application in process</option>
                                            <option value="quality_check" {{ old('status') == 'quality_check' ? 'selected' : '' }}>Quality Check</option>
                                            <option value="report_completed_positive" {{ old('status') == 'report_completed_positive' ? 'selected' : '' }}>Report Completed (positive)</option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                     ...
                                     <div class="col-xl-6">
                                        ...
                                        <input type="file" name="file[]" multiple class="form-control @error('file.*') is-invalid @enderror" id="file" onchange="previewImage(event) width="200">
                                        @error('file.*')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
