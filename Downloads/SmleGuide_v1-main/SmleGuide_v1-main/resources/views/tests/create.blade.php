@extends('layouts.vertical', ['title' => 'Add Test name'])
    ...
    <div class="col-8 m-auto ">
        <div class="card">
            ...
            <div class="card-header">
                <h5 class="card-title mb-0">Add Test Name</h5>
            </div><!-- end card header -->
                        ...
                        <form action="{{ route('tests.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" placeholder="Enter Test name" required value="{{ old('name') }}">
                                    @error('name')
