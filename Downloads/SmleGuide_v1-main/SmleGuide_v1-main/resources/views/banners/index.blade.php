...
<div class="container-fluid">
    ...
    <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
        ...
        <div class="d-flex justify-content-end flex-wrap gap-3 pt-3 px-3">
                    <a href="{{ route('banners.create') }}" class="btn btn-outline-primary">
                        Add Banners
                    </a>
                </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                 <table class="bannersTable table table-striped dt-responsive nowrap w-100">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Name</th>
...
<script>
    ...
    $('.bannersTable').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{ route('banners.index') }}', // This uses Ziggy, see note below
        columns: [
            { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
            { data: 'name', name: 'name' },
            { data: 'featured', name: 'featured' },
             { data: 'status', name: 'validity_days' },
        ...
        language: {
            ...
            emptyTable: "No banner files found"
        }
    });
});
</script>
