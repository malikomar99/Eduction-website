@extends('layouts.vertical', ['title' => 'Create Banner'])
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="description" id="description" class="form-control"
                                            placeholder="Enter Banner Description" value="{{ old('description') }}">
                                        @error('description')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-12">
                                            ...
                                            <div class="col-sm-10 d-flex gap-3">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="type"
                                                        id="banner_type_image" value="image" {{ old('type','image') == 'image' ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="banner_type_image">Image</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="type"
                                                        id="banner_type_video" value="video" {{ old('type') == 'video' ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="banner_type_video">Video</label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="type"
                                                        id="banner_type_link" value="video_link" {{ old('type') == 'video_link' ? 'checked' : '' }}>
                                        ...
                                        <div id="banner-image-fields" class="row g-3" style="display: none;">
                                                        ...
                                                        <div class="__custom-upload-img w-100">
                                                            ...
                                                            <label
                                                                ...
                                                                <input type="file" name="image"
                                                                    value="{{ old('image') }}" id="customFile1"
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input type="url" name="image_redirection_link" value="{{ old('image_redirection_link') }}" id="image_redirection_link"
                                        ...
                                        <div id="banner-link-fields" class="row g-3" style="display: none;">
                                            <div class="col-12">
                                                <label for="video_link" class="form-label">Video Link <span
                                                        class="text-danger">*</span></label>
                                                <input type="url" name="video_link" id="video_link" value="{{ old('video_link') }}" class="form-control"
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control flatpickr-input active"
                                                id="from_date" required name="from_date" placeholder="From Date">
                                                @error('from_date')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label class="form-label required">Till Date <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control flatpickr-input active"
                                                id="to_date" required name="to_date" placeholder="Till Date">
                                                @error('to_date')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                        </div>
