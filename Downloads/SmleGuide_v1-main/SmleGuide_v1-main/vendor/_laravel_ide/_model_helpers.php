...
namespace App\Models {
     ...
     * @property string $dataflow_password
     * @property string $dataflow_email
     * @property string $passport_no
     * @property string $name
     * @property mixed $title
     * @property int $id
     * @property-read mixed $status_badge_class
     * @method static \Illuminate\Database\Eloquent\Builder<Dataflow>|Dataflow whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Dataflow>|Dataflow whereTitle($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Dataflow>|Dataflow whereName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Dataflow>|Dataflow wherePassportNo($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Dataflow>|Dataflow whereDataflowEmail($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Dataflow>|Dataflow whereDataflowPassword($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Dataflow>|Dataflow whereServiceId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Dataflow>|Dataflow whereServiceName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Dataflow>|Dataflow whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Dataflow>|Dataflow whereFile($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Dataflow>|Dataflow whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Dataflow>|Dataflow whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Dataflow>|Dataflow newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Dataflow>|Dataflow newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Dataflow>|Dataflow query()
     ...
     */
    class Dataflow extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Service>|Service whereServiceAmount($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Service>|Service whereDiscountedAmount($value)
